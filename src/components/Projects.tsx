  ...
  return (
    <section className="py-32 bg-surface-container-low" id="projects">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-8 group relative overflow-hidden rounded-xl bg-surface-container-high aspect-[3/4] sm:aspect-video md:aspect-auto">
          <img
            alt="H7 Escalas Dashboard — enterprise scheduling platform"
            className="w-full h-full object-cover opacity-60 group-hover:scale-105 transition-transform duration-700"
            src="/projects/h7.png"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-surface-container-lowest via-surface-container-lowest/40 to-transparent p-6 sm:p-12 flex flex-col justify-end">
            <span className="text-primary font-bold tracking-widest text-xs uppercase mb-4">Case Principal</span>
            <h3 className="text-xl sm:text-3xl md:text-4xl font-bold mb-4">H7 Escalas</h3>
            <p className="text-on-surface-variant text-base sm:text-lg max-w-xl mb-6">
        ...
        <div className="md:col-span-4 group relative overflow-hidden rounded-xl bg-surface-container-high">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-surface-container-lowest to-transparent p-6 sm:p-12 flex flex-col justify-end">
